...
export class PythonScript {
    ...
    run(deleteAfterRun:boolean=true, callback?:(error:Error, stdout:string, stderr:string)=>void):void {
        if (deleteAfterRun) {
    ...
    // it'd be cool to have a function that can write a declarations file for a python library.
