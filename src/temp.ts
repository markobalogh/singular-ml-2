...
let algo = new NearestNeighbors().withDistanceMetric(EuclideanDistanceMetric).withDistanceWeighting('generalizedGaussian').withZeroDistanceHandling('continue').withExponent(2).withSigma(0.01);
