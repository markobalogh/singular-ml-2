...
let algo = new nearestNeighbors_1.NearestNeighbors().withDistanceMetric('euclidean').withDistanceWeighting('generalizedGaussian').withZeroDistanceHandling('continue').withExponent(2).withSigma(0.01);
